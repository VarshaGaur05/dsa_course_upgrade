...
true
false
The input 7 represents that in the next seven lines of input will be key-value pairs. The seven lines here are space-separated key-value pairs. The output is first true for the first 2 operations mentioned, which checks value=2, and the next one is false for the last 2 operations because the value of b, which is 3, is already removed.
